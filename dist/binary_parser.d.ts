...
export declare type Types = PrimitiveTypes | ComplexTypes;
export declare type ComplexTypes = 'bit' | 'string' | 'buffer' | 'array' | 'choice' | 'nest' | 'seek' | 'pointer' | 'saveOffset' | '';
export declare type Endianess = 'be' | 'le';
export declare type PrimitiveTypes = 'uint8' | 'uint16le' | 'uint16be' | 'uint32le' | 'uint32be' | 'uint64le' | 'uint64be' | 'int8' | 'int16le' | 'int16be' | 'int32le' | 'int32be' | 'int64le' | 'int64be' | 'floatle' | 'floatbe' | 'doublele' | 'doublebe';
